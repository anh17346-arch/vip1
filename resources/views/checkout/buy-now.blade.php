...
@section('title', 'Mua ngay - ' . $product->name)
...
<div class="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-950">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-2">Mua ngay</h1>
            <p class="text-slate-600 dark:text-slate-400">Hoàn tất thông tin để đặt hàng nhanh chóng</p>
        </div>
